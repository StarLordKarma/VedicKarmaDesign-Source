...
export default function Home() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!privacyAccepted) { setFormError(privacyFormCopy[locale].required); return; }
    if (!parsed.success) {
