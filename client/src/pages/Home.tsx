          ...
          <div className="mx-auto grid max-w-7xl gap-14 px-5 pb-20 pt-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-8 lg:pb-28 lg:pt-24">
            ...
            <div className="relative mx-auto w-full max-w-[500px]">
              ...
              <div className="absolute -bottom-5 -left-5 grid h-24 w-24 place-items-center rounded-2xl border border-[#e1b046]/40 bg-[#fffaf4] text-center shadow-xl">
                <div><p className="font-serif text-2xl text-[#b55b39]">{currencySymbol}{basicPrice}</p><p className="text-[10px] uppercase tracking-widest text-[#776d63]">{copy.basicLabel}</p></div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr] lg:items-start">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <article className="rounded-3xl bg-[#fffaf4] p-7 shadow-sm ring-1 ring-[#28231f]/8 sm:col-span-2">
                <div className="flex items-start justify-between gap-5"><div className="grid h-12 w-12 place-items-center rounded-2xl bg-[#f1dfd6] text-[#b55b39]"><Moon size={22} /></div><span className="font-serif text-3xl">{currencySymbol}{basicPrice}</span></div>
              ...
              <article className="rounded-3xl border border-[#d9a441]/35 bg-[#f4ead5] p-7 sm:col-span-2 sm:flex sm:items-center sm:justify-between sm:gap-8">
                <div><div className="flex items-center gap-3"><div className="grid h-10 w-10 place-items-center rounded-xl bg-[#d9a441]/20 text-[#9c7012]"><Gem size={20} /></div><span className="text-xs font-semibold uppercase tracking-[0.18em] text-[#9c7012]">{copy.optional}</span></div><h3 className="mt-4 font-serif text-2xl">{copy.addOn}</h3><p className="mt-2 max-w-xl text-sm leading-6 text-[#675944]">{copy.addOnBody}</p></div><div className="mt-6 shrink-0 font-serif text-3xl text-[#9c7012] sm:mt-0">+{currencySymbol}{addonPrice}</div>
              </article>
            </div>
          </div>
        </section>
