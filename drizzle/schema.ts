...
export const bookingRequests = mysqlTable("booking_requests", {
  ...
  privacyConsentVersion: varchar("privacyConsentVersion", { length: 64 }),
  privacyConsentLocale: varchar("privacyConsentLocale", { length: 8 }),
...
export const reportJobs = mysqlTable("report_jobs", {
  ...
  testJob: boolean("testJob").notNull().default(false),
