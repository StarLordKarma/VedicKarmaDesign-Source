...
export const appRouter = router({
  ...
  admin: router({
    ...
    cleanupPaymentTestLabRuns: adminProcedure.mutation(() => cleanupExpiredPaymentTestLabRuns()),
